...
namespace SDC_Web.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
            var sDCContext = _context.Project.Include(p => p.Client).Include(p => p.DesignedByNavigation).Include(p => p.UpdatedByNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var project = await _context.Project
                .Include(p => p.Client)
                .Include(p => p.DesignedByNavigation)
        ...
        {
            ViewData["ClientId"] = new SelectList(_context.Client, "ClientId", "Company");
